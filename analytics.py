...
def show_analytics(conn, texts):
    ...
    color_scheme_1 = ["#0cc0df", "#ffde59"]  # اللون الأول
    color_scheme_2 = ["#ff3131", "#ff914d"]  # اللون الثاني
    color_scheme_3 = ["#8c52ff", "#5ce1e6"]  # اللون الثالث
    ...
    if complaints_data:
        ...
        with row1_col1:
            fig_cat = px.bar(df, x="category", color="category", title="Complaints by Category",
                             color_discrete_sequence=color_scheme_1)
        ...
        with row1_col2:
            fig_pri = px.pie(df, names="priority", title="Complaints by Priority",
                             color_discrete_sequence=color_scheme_2)
        ...
        with row2_col1:
            fig_status = px.pie(df, names="status", title="Complaints by Status",
                                color_discrete_sequence=color_scheme_3)
